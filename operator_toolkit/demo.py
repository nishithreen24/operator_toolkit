...
#print(I.trace())
#print(sigz.isPositive())
#print(sigz.spectral_decomposition())
rho = (psi @ psi.dagger())
#print(rho.von_neumann_entropy())
#print(rho.isPositive())
#print(rho.isHermitian())
#print(rho.trace())
#print(rho.spectral_decomposition())
...
#print(D.operator)
AB = sigz * I
#print(AB.partial_trace(dims = [2, 2], trace_out = 1))
